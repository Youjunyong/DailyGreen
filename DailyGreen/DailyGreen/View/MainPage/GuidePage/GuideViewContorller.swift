...
class GuideViewController: UIViewController{
    ...
    let bodyArr = [
                   ...
                   "#dummy1쓰레기를 잘 분류를 하여 재활용 수거함에 버려보세요! 라벨 같이 재질이 다른 부분이 있다면 분리시켜 주시고 깨끗하게 씻어서 분리배출을 합니다. 너무 복잡하다구요? 도움말은 여기를 참고해보세요!",
                   "쓰레기를 잘 분류를 하여 재활용 수거함에 버려보세요! 라벨 같이 재질이 다른 부분이 있다면 분리시켜 주시고 깨끗하게 씻어서 분리배출을 합니다. 너무 복잡하다구요? 도움말은 여기를 참고해보세요! ",
                   "#dummy2쓰레기를 잘 분류를 하여 재활용 수거함에 버려보세요! 라벨 같이 재질이 다른 부분이 있다면 분리시켜 주시고 깨끗하게 씻어서 분리배출을 합니다. 너무 복잡하다구요? 도움말은 여기를 참고해보세요!",
    ...
    @objc func expandCell(_ sender: UIButton) {
        ...
        print("expanedCellArr :",expandedCellArr)
